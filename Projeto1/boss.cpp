...
void Boss::shootPattern2()
{
    if(healthbar > 0)
    {
        ...
        {
            shootDelay.start();
            Bullet *b = new Bullet(glWidget, bulletSpawn[pattAux1]+QVector2D(0, -0.045), QVector2D(0, -0.005), 0.035, QVector2D((pattAux2/5.0+bulletSpawn[pattAux1].x())/7500, -0.00005));
