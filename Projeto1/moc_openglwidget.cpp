...
QT_MOC_LITERAL(5, 42, 10), // "enableText"
QT_MOC_LITERAL(6, 53, 17), // "enableStartButton"
QT_MOC_LITERAL(7, 71, 16), // "enableQuitButton"
QT_MOC_LITERAL(8, 88, 9), // "startGame"
QT_MOC_LITERAL(9, 98, 13) // "updateObjects"

    },
    "OpenGLWidget\0showLifes\0\0showScore\0"
    "setText\0enableText\0enableStartButton\0"
    "enableQuitButton\0startGame\0updateObjects"
};
...
void OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->enableText(); break;
        case 4: _t->enableStartButton(); break;
        case 5: _t->enableQuitButton(); break;
        case 6: _t->startGame(); break;
        case 7: _t->updateObjects(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OpenGLWidget::enableText)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (OpenGLWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OpenGLWidget::enableStartButton)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (OpenGLWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OpenGLWidget::enableQuitButton)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 3
void OpenGLWidget::enableText()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void OpenGLWidget::enableStartButton()
{
    QMetaObject::activate(this, &staticMetaObject, 4, nullptr);
}

// SIGNAL 5
void OpenGLWidget::enableQuitButton()
{
